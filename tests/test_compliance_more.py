...
def test_score_compliance_sig_tuple_edge_cases() -> None:
            ...
            "test": [
                {
                    ...
                    "kind": "function",
                    "params": [
                        {"name": "a", "kind": "POSITIONAL_OR_KEYWORD", "default": "'```(None)```'", "annotation": '"str"'},
                        {"name": "b", "kind": "POSITIONAL_OR_KEYWORD", "default": "```(None)```", "annotation": "'int'"},
                        {"name": "c", "kind": "POSITIONAL_OR_KEYWORD", "default": "'___NONE___'", "annotation": "float"},
                    ],
                    "docstring": "",
                    "aliases": [],
                    "returns_type": "None",
    ...
    target_refs = [
        GhostRef(
            ...
            kind="function",
            params=[
                GhostParam(name="a", kind="POSITIONAL_OR_KEYWORD", default="None", annotation="str"),
                GhostParam(name="b", kind="POSITIONAL_OR_KEYWORD", default="None", annotation="int"),
                GhostParam(name="c", kind="POSITIONAL_OR_KEYWORD", default="None", annotation="float"),
            ],
            docstring="",
            aliases=[],
            returns_type="None",
...
def test_score_compliance_varargs_fallback_special_cases() -> None:
            ...
            "test": [
                {
                    ...
                    "kind": "function",
                    "params": [
                        {"name": "x", "kind": "POSITIONAL_OR_KEYWORD", "default": None, "annotation": None},
                    ],
                    "docstring": "",
                    "aliases": [],
                    "returns_type": "None",
    ...
    target_refs = [
        GhostRef(
            ...
            kind="function",
            params=[
                GhostParam(name="x", kind="POSITIONAL_OR_KEYWORD", default=None, annotation=None),
                GhostParam(name="args", kind="VAR_POSITIONAL", default=None, annotation=None),
            ],
            docstring="",
            aliases=[],
            returns_type="None",
